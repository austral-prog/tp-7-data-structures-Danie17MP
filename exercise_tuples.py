...
def convert_coordinate(coordenada):
    ...
    """
    sep_coordenada = tuple(coordenada)
    return sep_coordenada
...
def create_record(registro_azara, registro_rui):
    ...
    coord_azara = convert_coordinate(coord_azara)
    if coord_azara == coord_rui:
        lista_registro = registro_azara + registro_rui
        tupla_registro = tuple(lista_registro)
        return tupla_registro
    else:
        return "not a match"
